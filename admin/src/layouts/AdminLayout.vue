...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Müzayedeler', to: '/auctions', icon: 'pi pi-bolt' },
      { label: 'Müzayede Etkinlikleri', to: '/auction-events', icon: 'pi pi-calendar' },
      { label: 'Katılım Başvuruları', to: '/auction-registrations', icon: 'pi pi-user-plus' },
      { label: 'Müzayede Teklifleri', to: '/bids', icon: 'pi pi-sort-amount-up' },
      { label: 'Pazarlık Sohbetleri', to: '/negotiations', icon: 'pi pi-comments' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Mobil Anasayfa', to: '/mobile-config?area=home', icon: 'pi pi-home' },
