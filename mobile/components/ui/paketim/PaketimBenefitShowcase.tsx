...
import { styles } from './PaketimBenefitShowcase.styles';

export interface PaketimBenefitShowcaseProps {
  packageName: string;
  benefits: string[];
  sellerOnly: boolean;
...
export function PaketimBenefitShowcase({
  packageName,
  benefits,
  sellerOnly,
  highlightedBenefit,
}: PaketimBenefitShowcaseProps) {
