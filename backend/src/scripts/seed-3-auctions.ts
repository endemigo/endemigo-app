...
const ANTIQUE_PRODUCTS: SeedProduct[] = [
  {
    ...
    description:
      '19. yüzyıl sonuna tarihlenen, köstekli gümüş cep saati. Mekanik kurmalı, çalışır durumda.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Pocket_watch_with_chain.jpg/960px-Pocket_watch_with_chain.jpg',
  },
  {
    title: 'Antika Pirinç Semaver',
    description:
      'Geleneksel el işçiliği pirinç semaver. Gövdesinde dönem işçiliği kabartmalar bulunur.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/2024.03.30_Brass_Samovar_Flea_market_in_Minsk.jpg/960px-2024.03.30_Brass_Samovar_Flea_market_in_Minsk.jpg',
  },
  {
    title: 'Antika Gramofon',
    description:
      'Borulu, kurmalı taş plak gramofon. Ahşap kasası orijinaldir, çalışır durumda.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Antique_HMV_gramophone-_phonograph-_record_player.jpg/960px-Antique_HMV_gramophone-_phonograph-_record_player.jpg',
  },
  {
    title: 'Eski Daktilo',
    description:
      '20. yüzyıl başına ait mekanik daktilo. Tuş takımı eksiksiz, koleksiyonluk parça.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Vienna_-_Vintage_typewriter_-_0141.jpg/960px-Vienna_-_Vintage_typewriter_-_0141.jpg',
  },
  {
    title: 'Sarkaçlı Antika Duvar Saati',
    description:
      'Ahşap kasalı, sarkaçlı duvar saati. Kadranı orijinal, mekanizması revizyonludur.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Irish_Pendulum_Wall_Clock.jpg/960px-Irish_Pendulum_Wall_Clock.jpg',
  },
  {
    title: 'Antika Bakır İbrik',
    description:
      'El dövmesi bakır ibrik. Kalaylı, gövdesinde usta işçiliği görülür.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/N.H._Yeckley%2C_Copper_Pitcher%2C_1935-1942%2C_NGA_29557.jpg/960px-N.H._Yeckley%2C_Copper_Pitcher%2C_1935-1942%2C_NGA_29557.jpg',
  },
  {
    title: 'Körüklü Antika Fotoğraf Makinesi',
    description:
      'Körüklü analog fotoğraf makinesi. Optikleri temiz, körüğü sağlamdır.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c6/Vintage_Kodak_Junior_Six-20_Series_II_Folding_Film_Camera_%2815869618824%29.jpg/960px-Vintage_Kodak_Junior_Six-20_Series_II_Folding_Film_Camera_%2815869618824%29.jpg',
  },
  {
    title: 'Antika Gaz Lambası',
    description:
      'Fitilli antika gaz lambası. Camı orijinal, gövdesi sağlamdır.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Gas_Lamp_MET_ADA202.jpg/960px-Gas_Lamp_MET_ADA202.jpg',
  },
  {
    title: 'Antika Gümüş Şamdan',
    description: 'İşlemeli gümüş şamdan. Dönem işçiliği, damgalıdır.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Frank_M._Keane%2C_Silver_Candlestick%2C_1935-1942%2C_NGA_26589.jpg/960px-Frank_M._Keane%2C_Silver_Candlestick%2C_1935-1942%2C_NGA_26589.jpg',
  },
  {
    title: 'Lambalı Antika Radyo',
    description: 'Ahşap kasalı lambalı radyo. Kabini orijinal, koleksiyonluk.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Old_vintage_radio_-_Offenburg.jpg/960px-Old_vintage_radio_-_Offenburg.jpg',
  },
];
...
const BOOK_PRODUCTS: SeedProduct[] = [
  {
    ...
    description:
      'Deri ciltli, kapağı kabartma işlemeli antika kitap. Sayfaları sağlam.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/a/a5/Decorated_leather_binding%2C_family_bible%2C_19th_century.jpg',
  },
  {
    title: 'Osmanlıca El Yazması',
    description:
      'Osmanlıca el yazması eser. Dönemine göre iyi kondisyonda, sayfaları eksiksiz.',
    imageUrl:
  ...
  },
  {
    ...
    description:
      '18. yüzyıl gravür dünya haritası. Çift yarımküre kompozisyonlu, koleksiyonluk baskı.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/1794_Samuel_Dunn_Wall_Map_of_the_World_in_Hemispheres_-_Geographicus_-_World2-dunn-1794.jpg/960px-1794_Samuel_Dunn_Wall_Map_of_the_World_in_Hemispheres_-_Geographicus_-_World2-dunn-1794.jpg',
  },
  {
    title: 'Hat Sanatı Levha',
    description:
      'Talik hatla yazılmış hat sanatı levha. Klasik üslupta, tezhipli.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Calligraphic_panel_%28nasta%27liq%29.jpg/960px-Calligraphic_panel_%28nasta%27liq%29.jpg',
  },
  {
    title: 'Kabartma Deri Ciltli Yazma Eser',
    description:
      'Kabartma deri cildiyle nadir yazma eser. Cilt işçiliği dönem karakteristiğindedir.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Embossed_leather_binding_on_12th_century_manuscript_LCCN2006681054.jpg/960px-Embossed_leather_binding_on_12th_century_manuscript_LCCN2006681054.jpg',
  },
  {
    title: 'Antika Ansiklopedi Seti',
    description:
      'Cilt takımı halinde antika ansiklopedi seti. Ciltleri sağlam, seri tamdır.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Encyclopedia_Britannica%2C_9th_edition%2C_on_a_bookcase.jpg/960px-Encyclopedia_Britannica%2C_9th_edition%2C_on_a_bookcase.jpg',
  },
  {
    title: 'Tarihi Gazete Arşivi',
    description:
      '20. yüzyıl başına ait tarihi gazete. Ön sayfası eksiksiz, okunur durumda.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/Front_page_of_newspaper_Wilnaer_Zeitung_with_Lithuanian_Vytis_%28Waykimas%29%2C_published_on_12_April_1918.jpg/960px-Front_page_of_newspaper_Wilnaer_Zeitung_with_Lithuanian_Vytis_%28Waykimas%29%2C_published_on_12_April_1918.jpg',
  },
  {
    title: 'Antika Kartpostal',
    description:
      'Dönem fotoğraflı antika kartpostal. Renkleri canlı, kondisyonu iyidir.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Fairmount_park_vintage_postcard_1.jpg/960px-Fairmount_park_vintage_postcard_1.jpg',
  },
  {
    title: 'Minyatürlü Yazma Eser',
    description:
      'Minyatürle bezeli yazma eser sayfası. Altın yaldız detaylı, müzelik kalitede.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Miraj_by_Sultan_Muhammad.jpg/960px-Miraj_by_Sultan_Muhammad.jpg',
  },
  {
    title: 'Antika Gravür Baskı',
    description: '18. yüzyıl gravür baskı. Asitsiz paspartu ile korunmuştur.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Easton_Lodge_Essex_England_18th-century_engraving_01.jpg/960px-Easton_Lodge_Essex_England_18th-century_engraving_01.jpg',
  },
];
...
const RUG_PRODUCTS: SeedProduct[] = [
  {
    ...
    description:
      'Kök boyalı, el dokuması Anadolu kilimi. Geometrik motifli, sağlam dokuda.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Antalya_museum_Anatolian_%E2%80%98slit-kilim%E2%80%99_Mid-20th_century_4847.jpg/960px-Antalya_museum_Anatolian_%E2%80%98slit-kilim%E2%80%99_Mid-20th_century_4847.jpg',
  },
  {
    title: 'Hereke İpek Halı',
    description:
      'İnce dokuma Hereke ipek halı. Yüksek düğüm yoğunluğu, canlı renkler.',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'Yıldız madalyonlu klasik Uşak halısı. Doğal boyalı, dönem dokuması.',
    imageUrl:
  ...
  },
  {
    title: 'Kafkas Halısı',
    description:
      '19. yüzyıl Kafkas halısı. Geleneksel motifli, yünü parlak, renkleri doğal.',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'El dokuması antika Anadolu seccadesi. Mihrap desenli, koleksiyonluk.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/b/b0/Antique_Anatolian_Prayer_Rug.jpg',
  },
  {
    title: 'El Dokuması Heybe',
    description:
      'El dokuması çift gözlü heybe. Orijinal detayları korunmuştur.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Double_Saddlebag_%28Khorjin%29_MET_DP700915.jpg/960px-Double_Saddlebag_%28Khorjin%29_MET_DP700915.jpg',
  },
  {
    title: 'El Dokuması Yolluk Kilim',
    description:
      'Konya yöresi el dokuması yolluk kilim. Kullanıma ve sergilemeye uygundur.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Istanbul_Former_Mint_Kilim_exposition_Floor_covering_%28%E2%80%98Yolluk%E2%80%99_Runner%29._Kilim._From_the_Konya_region_Detail_in_2003_13.jpg/960px-Istanbul_Former_Mint_Kilim_exposition_Floor_covering_%28%E2%80%98Yolluk%E2%80%99_Runner%29._Kilim._From_the_Konya_region_Detail_in_2003_13.jpg',
  },
  {
    title: 'Antika İran Halısı',
    description:
      'Madalyonlu antika İran halısı. Bitkisel boyalı, zemin deseni yoğun işlemelidir.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/0/0f/Indo-Persian_carpet_with_medallions_MET_DP265209.jpg',
  },
  {
    title: 'Kilim Yastık',
    description:
      'Eski kilim parçasından dikilmiş yastık. Ön yüzü el dokuması orijinal kilimdir.',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'Selçuklu dönemi karakterinde antika halı. Müzelik nitelikte, nadir parça.',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Seljuq_Rug_from_the_Alaaddin_Mosque_in_Konya_%28TIEM_681%29.jpg/960px-Seljuq_Rug_from_the_Alaaddin_Mosque_in_Konya_%28TIEM_681%29.jpg',
  },
];
...
async function run() {
  ...
  try {
    ...
    if (!seller) {
      throw new Error(
        'No user found in database to act as seller. Please seed users first.',
      );
    }
    ...
    const eventsData = [
      {
        ...
        description:
          'Bu şu anda devam etmekte olan canlı müzayedemizdir. Antika saatler, gramofonlar, gümüş objeler ve dönem eşyaları bu müzayedede yer almaktadır.',
      ...
      },
      {
        ...
        description:
          'Yaklaşık 1 saat sonra başlayacak olan bu müzayedede el yazmaları, hat levhaları, gravür baskılar ve nadir koleksiyon kitapları yer almaktadır.',
      ...
      },
      {
        ...
        description:
          'Yarın başlayacak olan bu müzayedede asırlık el dokuması Anadolu kilimleri ve ipek Hereke halıları satışa sunulacaktır.',
        status: AuctionEventStatus.UPCOMING,
    ...
    const lot1 = auctions.find(
      (a) => a.eventId === event1.id && a.sequenceNumber === 1,
    );
    if (lot1) {
    ...
    if (lot1) {
      ...
      console.log(
        `Scheduled end-auction job for Event 1 Lot 1 in ${Math.round(delay / 1000)} seconds.`,
      );
    }
