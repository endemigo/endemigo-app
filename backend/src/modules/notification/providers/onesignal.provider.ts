...
const TRANSLATIONS: Record<string, string> = {
  ...
  // Bodies
  'Your payment is secured and the seller can now prepare the order.': 'Ödemeniz güvence altına alındı, satıcı siparişi hazırlamaya başlayabilir.',
  'A paid order is waiting for shipment preparation.': 'Yeni bir ödenmiş sipariş sevkiyat hazırlığı bekliyor.',
  'Your order is being prepared for shipment.': 'Siparişiniz sevkiyat için hazırlanıyor.',
  'The order is now marked as preparing shipment.': 'Sipariş, sevkiyat hazırlığında olarak işaretlendi.',
  'Your order is now in transit.': 'Siparişiniz yolda.',
  'The shipment has been handed over to cargo.': 'Gönderiniz kargoya teslim edildi.',
  'Your order was delivered. You can now confirm delivery.': 'Siparişiniz teslim edildi. Teslimatı onaylayabilirsiniz.',
  'The shipment is marked as delivered.': 'Gönderi teslim edildi olarak işaretlendi.',
  'The order is completed successfully.': 'Sipariş başarıyla tamamlandı.',
  'The order is completed and payout can proceed.': 'Sipariş tamamlandı, satıcı ödemesi aktarılabilir.',
  'Your return request has been created.': 'İade talebiniz oluşturuldu.',
  'A buyer opened a return request for this order.': 'Alıcı bu sipariş için iade talebi oluşturdu.',
  'Your return request was approved. Return shipment is now active.': 'İade talebiniz onaylandı. İade kargosu aktif.',
  'The return request has been approved and shipment was created.': 'İade talebi onaylandı ve kargo kaydı oluşturuldu.',
  ...
  'The return shipment was delivered to you.': 'İade kargosu tarafınıza teslim edildi.',
  'Refund processing has started for this order.': 'Bu sipariş için iade/refund işlemi başlatıldı.',
  'Your refund was completed successfully.': 'İade/refund işleminiz başarıyla tamamlandı.',
  'Refund for this order has been completed.': 'Bu sipariş için iade/refund işlemi tamamlandı.',

  'The cargo record has been created.': 'Kargo kaydı oluşturuldu.',
  'The return cargo record has been created.': 'İade kargosu kaydı oluşturuldu.',
  ...
  'The cargo encountered a delivery failure.': 'Kargo teslimatında sorun oluştu.',
  'The return cargo encountered a delivery failure.': 'İade kargosu teslimatında sorun oluştu.',
  'The cargo status has been updated.': 'Kargo durumu güncellendi.',
  'The return cargo status has been updated.': 'İade kargosu durumu güncellendi.',

  'An accepted Ask Price offer is ready for order processing.': 'Kabul edilen Fiyat Sor teklifi sipariş işlemi için hazır.',
};
