...
export class UpdateProfileDto {
  ...
  @IsString()
  @Matches(/^\+[1-9]\d{1,14}$/, {
    message: 'Telefon numarası E.164 formatında olmalıdır (+905551234567)',
  })
  phone?: string;
  ...
  @ApiPropertyOptional({
    example: 'https://cdn.endemigo.com/avatars/user123.jpg',
  })
  @IsOptional()
  @IsUrl(
    { protocols: ['https'], require_protocol: true },
    { message: 'Avatar URL HTTPS formatında olmalıdır' },
  )
  avatarUrl?: string;
}
